...
import random as rn
from rician_custom_layers import Rician, X_matrix, Y_matrix, Kz
...
encoded3 = Rician(alpha1)(encoded2)
...
plt.plot(EbNodB_range, ber, linestyle='--', color='b', marker='o', label='Rician Fixed (3,3)')
print(ber)
np.save('A_rician33_fixed_7dB', ber)
...
plt.savefig('A_rician33_fixed_7dB')
plt.show()